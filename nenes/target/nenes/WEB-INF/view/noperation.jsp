...
<body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
    ...
    <div class="jumbotron text-center">
        <h1>Operation</h1>
        <p>send operation message to connected nenea(agent)</p>
        
<form:form class="form-horizontal" action="noperation" method="post" commandName="message">

  <div class="form-group">
    <label class="control-label col-sm-4" for="operation">Choice : </label>
    <div class="agent col-sm-4">
        <form:checkboxes path="agent" items="${agents}" />
    </div>
  </div>

  <div class="form-group">
    <label class="control-label col-sm-4" for="operation">Operation : </label>
    <div class="col-sm-6">
      <input type="text" class="form-control" id="msg" name="msg" placeholder="enter operation message">
    </div>
  </div>
