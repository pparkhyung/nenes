...
<body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
        ...
        <div class="container">
            ...
            <div id="navbar" class="collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="<c:url value="/ncommand" />">message</a></li>
    ...
    <div class="jumbotron text-center">
        <h1>Text Message</h1>
        <p>send text message to connected agent(telnet, putty)</p>
        
<form:form class="form-horizontal" action="ncommand" method="post" commandName="message">
  ...
  <div class="form-group">
    <label class="control-label col-sm-4" for="operation">Message : </label>
    <div class="col-sm-6">
      <input type="text" class="form-control" id="msg" name="msg" placeholder="enter text message">
    </div>
  </div>
