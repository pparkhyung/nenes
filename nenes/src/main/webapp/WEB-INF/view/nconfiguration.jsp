...
<!-- Bootstrap -->
<link href="/nenes/resource/bootstrap/css/bootstrap.min.css" rel="stylesheet">
...
<body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
        ...
        <div class="container">
            ...
            <div id="navbar" class="collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li  class="active"><a href="<c:url value="/nconfiguration" />">configuration</a></li>
                </ul>
            </div>
            <!--/.nav-collapse -->
        </div>
    ...
    <div class="jumbotron text-center">
        <h1>Configuration</h1>
        <p>Configuration under construction</p>
        
<form:form class="form-horizontal" action="nconfiguration" method="post" commandName="configuration">

  <div class="form-group">
    <label class="control-label col-sm-4" for="operation">File Location : </label>
    <div class="col-sm-6">
      <input type="text" class="form-control" id="fileDirectory" name="fileDirectory" value="${configuration.fileDirectory}">
    </div>
  </div>
